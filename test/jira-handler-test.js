import {getAPIConfig, getAuthentication, validateAPIConfig, validateAuthentication, getJiraAPI, getJiraIssue} from '../src/jira-handler.js';
...
describe('jira-handler tests', function(){
	describe('APIConfig', function() {
		...
		it('Bad API Config', function(){
			assert.throw( () => { validateAPIConfig(badJiraObject); }, '.jirarc missing required field(s)');
		});
	});

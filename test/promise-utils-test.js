...
describe('Any Promise Tests', () => {
  it('No args', () => {
    promiseUtils.anyPromise()
      .should.eventually.be.rejectedWith(Error, 'No arguments provided');
  });

  it('Non-array argument', () => {
    const testArgs = 0;
    return promiseUtils.anyPromise(testArgs)
      .should.eventually.be.rejectedWith(Error, 'Argument is not a non-array');
  });
  ...
  it('Successful single promise', () => {
    ...
    return promiseUtils.anyPromise(testPromiseArray)
  ...
  it('Unsuccessful single promise', () => {
    ...
    return promiseUtils.anyPromise(testPromiseArray)
      .should.eventually.be.rejectedWith(Error, 'Failed');
  });
  ...
  it('2 failures', () => {
    ...
    return promiseUtils.anyPromise(testPromiseArray)
      .should.eventually.be.rejectedWith([err1, err2]);
  });
  ...
  it('3 failures', () => {
    ...
    return promiseUtils.anyPromise(testPromiseArray)
      .should.eventually.be.rejectedWith([err1, err2, err3]);
  });
